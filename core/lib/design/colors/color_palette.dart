...
/// Theme Colors
const Color kcAccent = kcViolet;
const Color kcDanger = kcRed;
const Color kcSuccess = kcGreen;
const Color kcInfo = kcBlue;
const Color kcWarning = kcAmber;

const MaterialColor kcSlate = MaterialColor(0xFF64748B, <int, Color>{
  50: Color(0xFFF8FAFC),
...
const MaterialColor kcGray = MaterialColor(0xFF6B7280, <int, Color>{
  50: Color(0xFFF9FAFB),
...
const MaterialColor kcZinc = MaterialColor(0xFF71717A, <int, Color>{
  50: Color(0xFFFAFAFA),
...
const MaterialColor kcNeutral = MaterialColor(0xFF737373, <int, Color>{
  50: Color(0xFFFAFAFA),
...
const MaterialColor kcStone = MaterialColor(0xFF78716C, <int, Color>{
  50: Color(0xFFFAFAF9),
...
const MaterialColor kcRed = MaterialColor(0xFFEF4444, <int, Color>{
  50: Color(0xFFFEF2F2),
...
const MaterialColor kcOrange = MaterialColor(0xFFF97316, <int, Color>{
  50: Color(0xFFFFF7ED),
...
const MaterialColor kcAmber = MaterialColor(0xFFF59E0B, <int, Color>{
  50: Color(0xFFFFFBEB),
...
const MaterialColor kcYellow = MaterialColor(0xFFEAB308, <int, Color>{
  50: Color(0xFFFEFCE8),
...
const MaterialColor kcLime = MaterialColor(0xFF84CC16, <int, Color>{
  50: Color(0xFFF7FEE7),
...
const MaterialColor kcGreen = MaterialColor(0xFF22C55E, <int, Color>{
  50: Color(0xFFF0FDF4),
...
const MaterialColor kcEmerald = MaterialColor(0xFF10B981, <int, Color>{
  50: Color(0xFFECFDF5),
...
const MaterialColor kcTeal = MaterialColor(0xFF14B8A6, <int, Color>{
  50: Color(0xFFF0FDFA),
...
const MaterialColor kcCyan = MaterialColor(0xFF06B6D4, <int, Color>{
  50: Color(0xFFECFEFF),
...
const MaterialColor kcSky = MaterialColor(0xFF0EA5E9, <int, Color>{
  50: Color(0xFFF0F9FF),
...
const MaterialColor kcBlue = MaterialColor(0xFF3B82F6, <int, Color>{
  50: Color(0xFFEFF6FF),
...
const MaterialColor kcIndigo = MaterialColor(0xFF6366F1, <int, Color>{
  50: Color(0xFFEEF2FF),
...
const MaterialColor kcViolet = MaterialColor(0xFF8B5CF6, <int, Color>{
  50: Color(0xFFF5F3FF),
...
const MaterialColor kcPurple = MaterialColor(0xFFA855F7, <int, Color>{
  50: Color(0xFFFAF5FF),
...
const MaterialColor kcFuchsia = MaterialColor(0xFFD946EF, <int, Color>{
  50: Color(0xFFFDF4FF),
...
const MaterialColor kcPink = MaterialColor(0xFFEC4899, <int, Color>{
  50: Color(0xFFFDF2F8),
...
const MaterialColor kcRose = MaterialColor(0xFFF43F5E, <int, Color>{
  50: Color(0xFFFFF1F2),
